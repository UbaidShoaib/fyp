                            ...
                            <div class="sj-widgetdashboard">
                                <nav id="sj-dashboardnav" class="sj-dashboardnav">
                                    <ul>
                                        ...
                                        <li><a href="author_reviewer.html"><i class="lnr lnr-lock"></i> <span>Requests For Article Review</span></a></li>
                                ...
                                <li id="collapseOne" class="collapse sj-active sj-userinfohold" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="sj-userinfoimgname">
                                        ...
                                        <div class="sj-userbtnarea">
                                            <button type="submit" class="sj-btn" data-toggle="modal" data-target="#feedbackmodal">Accept</button>
                                            <button type="submit" class="sj-btn" data-toggle="modal" data-target="#feedbackmodal">Reject</button>
                                        </div>
